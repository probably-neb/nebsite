this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
    ...
    var j = "nyt-wordle-darkmode", S = "nyt-wordle-cbmode", C = function (e) {
        ...
        function t() {
            ...
            return !0 === o || !1 === o ? e.setDarkTheme(o) : r && e.setDarkTheme(!0), !0 !== i && !1 !== i || e.setColorBlindTheme(i), window.themeManager = p(e), e
        }
    ...
    var G, F = I["__core-js_shared__"],
        W = (G = /[^.]+$/.exec(F && F.keys && F.keys.IE_PROTO || "")) ? "Symbol(src)_1." + G : "";
    ...
    function ee(e) {
        return !(!V(e) || (a = e, W && W in a)) && (B(e) ? Q : U).test(function (e) {
            if (null != e) {
                try {
                    return Y.call(e)
                } catch (e) {
    ...
    function na(e, a) {
        var s = Me(e), t = !s && Ie(e), o = !s && !t && $e(e), n = !s && !t && !o && Ke(e), r = s || t || o || n,
            i = r ? function (e, a) {
    ...
    function ca(e, a, s, t, o, n, r) {
        ...
        if (d) pe(e, s, d); else {
            ...
            if (p) {
                ...
                u = l, m || h || y ? Me(i) ? u = i : _e(c = i) && Re(c) ? u = function (e, a) {
                    var s = -1, t = e.length;
                    for (a || (a = Array(t)); ++s < t;) a[s] = e[s];
                    return a
                }(i) : h ? (p = !1, u = function (e, a) {
                    if (a) return e.slice();
                    var s = e.length, t = fe ? fe(s) : new e.constructor(s);
                    return e.copy(t), t
                }(l, !0)) : y ? (p = !1, u = ve(l, !0)) : u = [] : function (e) {
                ...
                }(l) || Ie(l) ? (u = i, Ie(i) ? u = da(i) : V(i) && !B(i) || (u = function (e) {
    ...
    function ua(e, a, s, t, o) {
        e !== a && he(a, (function (n, r) {
            if (o || (o = new de), V(n)) ca(e, a, r, s, ua, t, o); else {
    ...
    var ka, va = (ka = function (e, a, s) {
        ...
        for (n = ka.length > 3 && "function" == typeof n ? (o--, n) : void 0, r && function (e, s, t) {
            if (!V(t)) return !1;
            var o = a(s);
            return !!("number" == o ? Re(t) && ta(s, t.length) : "string" == o && s in t) && E(t[s], e)
    ...
    var ls = "IN_PROGRESS", ds = "WIN", cs = "FAIL",
        us = ["Genius", "Magnificent", "Impressive", "Splendid", "Great", "Phew"], ps = function (e) {
            r(t, e);
            var a = h(t);
            ...
            function t() {
                ...
                newWordle.attachShadow({mode: "open"}), newWordle.today = new Date, newWordle.refreshTimer = as(), newWordle.randDay = getPrevDay();
                var nullWordle = genNullWordleState();
                function getPrevDay() {
                    var randDate = new Date(+gameStartDate + Math.random() * (new Date - gameStartDate));
                ...
                //TODO: -> make button function, replace in html creater, replace in querySelector
                //TODO: color scheme -> either hand change colors in style or create new theme that can be switched too (might need both)
                //TODO: clean script of uneccessary stuff
                //ALL one tertiary op
                return newWordle.lastPlayedTs = nullWordle.lastPlayedTs, !newWordle.lastPlayedTs || true ? (newWordle.boardState = new Array(6).fill(""), newWordle.evaluations = new Array(6).fill(null), newWordle.solution = getAnswerByDay(newWordle.randDay), newWordle.dayOffset = getWordleDayOffset(newWordle.randDay), newWordle.lastCompletedTs = nullWordle.lastCompletedTs, newWordle.hardMode = nullWordle.hardMode, newWordle.restoringFromLocalStorage = !1, ja({
                    ...
                    //getDifferenceInDates(new Date(newWordle.lastPlayedTs), newWordle.today) >= 1
                    : (newWordle.boardState = nullWordle.boardState, newWordle.evaluations = nullWordle.evaluations, newWordle.rowIndex = nullWordle.rowIndex, newWordle.solution = nullWordle.solution, newWordle.dayOffset = getWordleDayOffset(newWordle.today), newWordle.letterEvaluations = $a(newWordle.boardState, newWordle.evaluations), newWordle.gameStatus = nullWordle.gameStatus, newWordle.lastCompletedTs = nullWordle.lastCompletedTs, newWordle.hardMode = nullWordle.hardMode, newWordle.gameStatus !== ls && (newWordle.canInput = !1), newWordle.restoringFromLocalStorage = !0), newWordle
            }
            ...
            return o(t, [{
                key: "evaluateRow", value: function () {
                    if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                        ...
                        if (e = s, !possibleEntries.includes(e) && !possibleAnswers.includes(e)) return a.setAttribute("invalid", ""), void this.addToast("Not in word list");
                        if (this.hardMode) {
                            var t = function (e, a, s) {
                                    ...
                                    for (var o = {}, n = 0; n < s.length; n++) [Ha, Ra].includes(s[n]) && (o[a[n]] ? o[a[n]] += 1 : o[a[n]] = 1);
                        ...
                        var r = function (e, a) {
                            for (var s = Array(a.length).fill(Na), t = Array(a.length).fill(!0), o = Array(a.length).fill(!0), n = 0; n < e.length; n++) e[n] === a[n] && o[n] && (s[n] = Ha, t[n] = !1, o[n] = !1);
                        ...
                        if (i || l) Za({
                            isWin: l,
                            isStreak: !!this.lastCompletedTs && 1 === getDifferenceInDates(new Date(this.lastCompletedTs), new Date),
                ...
                key: "connectedCallback", value: function () {
                    ...
                    this.$game.addEventListener("game-key-press", (function (e) {
                        ...
                        switch (s) {
                            case"hard-mode":
                                return void (o ? d.addToast("Hard mode can only be enabled at the start of a round", 1500, !0) : (d.hardMode = t, ja({hardMode: t})))
                        }
                    ...
                    //     d.showNavModal()
                    // })),
                    window.addEventListener("resize", this.sizeBoard.bind(this)), ns(), i = {
                    ...
                    }, i.modifier = i.prdstring, "dev" === i.env ? i.modifier = i.devstring : "stg" === i.env && (i.modifier = i.stgstring), function (window, document, s, t, o, n) {
                        window[t] = window[t] || [], window[t].push({"gtm.start": (new Date).getTime(), event: "gtm.js"});
                        var r = document.getElementsByTagName(s)[0], scriptElement = document.createElement(s);
                        scriptElement.async = !0, scriptElement.src = "https://www.googletagmanager.com/gtm.js?id=" + o + n + "&gtm_cookies_win=x", r.parentNode.insertBefore(scriptElement, r)
                    }/*(window, document, "script", "dataLayer", i.container, i.modifier), e = l, a = i.env, t = a && "prod" === a ? "a.nytimes.com" : "a.dev.nytimes.com", o = encodeURIComponent(document.referrer), n = encodeURIComponent((s = document.querySelector("link[rel=canonical]")) ? s.href : document.location.href), (r = new XMLHttpRequest).withCredentials = !0, r.open("GET", "https://" + t + "/svc/nyt/data-layer?sourceApp=" + e.application.name + "&referrer=" + o + "&assetUrl=" + n, !0), r.onload = function () {
    ...
    var hs = function (e) {
        ...
        return o(t, [{
            key: "connectedCallback", value: function () {
                var e = this;
                this.shadowRoot.appendChild(ms.content.cloneNode(!0)), this.addEventListener("click", (function (a) {
                ...
                key: "connectedCallback", value: function () {
                    ...
                    this.shadowRoot.appendChild(ys.content.cloneNode(!0)), this.$keyboard = this.shadowRoot.getElementById("keyboard"), this.$keyboard.addEventListener("click", (function (a) {
                        ...
                        if (!0 !== a.repeat) {
                            ...
                            t || o || (Wa.includes(s.toLowerCase()) || "Backspace" === s || "Enter" === s) && e.dispatchKeyPressEvent(s)
                        }
  ...
  ***************************************************************************** */
    ...
    var Bs = {
        ...
        function t() {
            var e;
            return s(this, t), n(p(e = a.call(this)), "stats", {}), n(p(e), "gameApp", void 0), e.attachShadow({mode: "open"}), e.stats = getStatistics(), e
        }
        ...
        return o(t, [{
            key: "connectedCallback", value: function () {
                ...
                if (Object.values(this.stats.guesses).every((function (e) {
                    ...
                    var r = n, i = this.stats.guesses[n], l = Ds.content.cloneNode(!0),
                ...
                if (["gamesPlayed", "winPercentage", "currentStreak", "maxStreak"].forEach((function (s) {
                    ...
                    p.appendChild(m), this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function (a) {
                        ...
                        Ns(function (e) {
                            var a = e.evaluations, dayOffset = e.dayOffset, rowOfCorrectGuess = e.rowIndex, hardMode = e.isHardMode, win = e.isWin,
                                r = JSON.parse(window.localStorage.getItem(j)),
                                i = JSON.parse(window.localStorage.getItem(S)), l = "Wordle ".concat(dayOffset);
                            l += " ".concat(win ? rowOfCorrectGuess : "X", "/").concat(6), hardMode && (l += "*");
